# To-Do Liste API
## Dette prosjektet er en interaktiv oppgavebehandler bygget med en moderne teknologistabel. Applikasjonen lar brukeren opprette, vise og administrere gjøremål i et brukervennlig grensesnitt.

# Teknologier og arkitektur:
## Backend: Utviklet i Python for å håndtere API-logikk og forespørsler.
